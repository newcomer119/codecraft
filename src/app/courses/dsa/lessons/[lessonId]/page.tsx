...
export default function LessonPage() {
  ...
  const handleNavigation = (direction: 'next' | 'previous') => {
    if (direction === 'next' && nextLesson) {
      router.push(`/courses/dsa/lessons/${nextLesson.id}`);
    } else if (direction === 'previous' && previousLesson) {
      router.push(`/courses/dsa/lessons/${previousLesson.id}`);
    }
  };
        ...
        <div className="p-6">
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              disabled={!nextLesson}
              className="px-4 py-2 bg-blue-600 hover:bg-blue-700 disabled:bg-gray-800 disabled:text-gray-500 text-white text-sm rounded-lg transition-colors flex items-center gap-2"
            >
              Next
